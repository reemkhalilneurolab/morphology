...
parser.add_argument('--species', required=False, type=str, help="species", metavar="A")
...
if (args.region):
  ...
  numNeurons = (args.neurons != -1 and args.neurons) or -1
  species = (args.species != -1 and args.species) or "ferret"
  get_swc_by_species(species, numNeurons)
elif (args.archive):
  numNeurons = (args.neurons != -1 and args.neurons) or -1
